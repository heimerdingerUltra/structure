...
class OptimizerFactory:
    ...
    @staticmethod
    def create_scheduler(optimizer: Optimizer, scheduler_name: str, epochs: int, **kwargs):
...
def configure_training(
    ...
    **kwargs,
    ...
    optimizer = OptimizerFactory.create_optimizer(
        model, optimizer_name, learning_rate, weight_decay, **kwargs.get("optimizer_kwargs", {})
    )

    scheduler = OptimizerFactory.create_scheduler(
        optimizer, scheduler_name, epochs, **kwargs.get("scheduler_kwargs", {})
    )
