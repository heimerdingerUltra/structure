...
class AutoML:
    ...
    def __init__(
        self, model_types: list, n_trials_per_model: int = 50, direction: str = "minimize"
    ):
    ...
    def run(self, objective_fn: Callable, storage: Optional[str] = None):
        for model_type in self.model_types:
            ...
            is_better = (self.direction == "minimize" and best_value < self.best_score) or (
    ...
    def get_leaderboard(self):
        ...
        leaderboard.sort(key=lambda x: x["score"], reverse=(self.direction == "maximize"))
