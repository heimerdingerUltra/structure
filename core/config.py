...
def get_optimal_config(gpu_memory_gb: int = 16, strategy: str = "balanced") -> Configuration:
    ...
    if strategy == "speed":
        return Configuration(
            ...
            model=Model(d_model=256, n_layers=8, n_heads=8),
        )
        ...
        return Configuration(
            ...
            model=Model(d_model=768, n_layers=16, n_heads=12, dropout=0.15),
        )
